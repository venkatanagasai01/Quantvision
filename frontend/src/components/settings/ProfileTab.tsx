  ...
  return (
    <div className="bg-[#0B1120] border border-white/5 rounded-xl shadow-sm">
      <div className="px-6 py-5 border-b border-white/5 bg-white/5">
        <h2 className="text-lg font-semibold text-white tracking-tight">Public Profile</h2>
        <p className="text-sm text-slate-400 mt-1">This information will be displayed on your reports.</p>
      </div>

      <form onSubmit={handleSubmit} className="p-6 max-w-2xl">
        <div className="flex items-center gap-6 mb-8">
          <div className="w-20 h-20 rounded-full bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden shrink-0">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="flex-1 px-3 py-2 text-sm bg-[#0B1120] border border-white/10 text-white rounded-lg outline-none focus:border-indigo-500"
              />
            </div>
            <p className="text-xs text-slate-400 mt-2">Provide a valid image URL for your avatar.</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-2 text-sm bg-[#0B1120] border border-white/10 text-white rounded-lg outline-none focus:border-indigo-500"
            />
          </div>
