...
export function TopNavbar() {
  ...
  return (
    <header className="h-20 bg-[#030712]/80 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-8 sticky top-0 z-20 shadow-sm">

      {/* Logo / Title Area (Optional, currently empty to shift items right) */}
      ...
      <div className="flex items-center gap-6 ml-4">
        ...
        <div className="relative">
          <button
            className="flex items-center gap-3 cursor-pointer hover:bg-white/5 px-2 py-1.5 rounded-xl transition-all"
          ...
          {showDropdown && (
            <>
              ...
              <div className="absolute right-0 mt-2 w-56 bg-[#0B1120] border border-white/10 rounded-xl shadow-xl shadow-black/50 py-2 z-50">
                {/* User info */}
